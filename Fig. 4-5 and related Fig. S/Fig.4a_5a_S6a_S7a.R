...
load("/mnt/data5/disk/chenfeng/NC2025review2nd/tRNAcounts/01.TAItRNAexp 03.Eco .Rdata")
...
#save(xijofD,file = "/mnt/data5/disk/chenfeng/NC2025review2nd/tRNAsupply/xijofD.Ecoli.Rdata")
...
save(DP.exp.tai,file = "/mnt/data5/disk/chenfeng/NC2025review2nd/tRNAsupply/dpexptai.ecoligene.Rdata")

#################################################################################################################################################################
#Fig 4a and S6a
library(tidyr)
load("/mnt/data5/disk/chenfeng/NC2025review2nd/tRNAsupply/dpexptai.ecoligene.Rdata")
...
write.csv(dfcor.D.imp,file = "/home/chenfeng/project/chenfengdata5/nc2025finalcheck/Fig.4a.csv")
dfcor.D.imp %>%
  ...
  scale_y_continuous("rho (Importance ~ D)",limits = c(-0.4,0.15),breaks = c(-0.4,-0.2,0,0.2,0.4,0.6,0.8)) +
  theme_classic() +
...
write.csv(dfcor.exp.D,file = "/home/chenfeng/project/chenfengdata5/nc2025finalcheck/Fig.5a.csv")
dfcor.exp.D %>%
  ggplot(aes(y=mrho,x=thres,fill=corWith,group=corWith)) +
  geom_bar(stat = "identity",position = "dodge",width = 0.8) +
  geom_errorbar(aes(ymax=mrho+sd,ymin=mrho-sd),position = position_dodge(width = 0.8),width = 0.3)+
