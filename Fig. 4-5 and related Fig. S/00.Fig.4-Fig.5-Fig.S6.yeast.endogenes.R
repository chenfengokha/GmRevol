...
load("/home/chenfeng/project/HGT/exp/tAIcodeyeast.Rdata")
...
save(DP.exp.tai,file = "/mnt/data/home/chenfeng/project/HGT/exp/fig4-5extended/dpexptai.yeastgene.Rdata")

#####################################################################################################################################################################################################
##fig4
load("/mnt/data/home/chenfeng/project/HGT/exp/fig4-5extended/dpexptai.yeastgene.Rdata")
...
dfcor.exp.D %>%
  ...
  geom_errorbar(aes(ymax=mrho+sd,ymin=mrho-sd),position = position_dodge(width = 0.8),width = 0.3)+
  scale_fill_manual(values=c("#9933FF", "grey"))+
  scale_y_continuous("rho (Expression ~ D)",limits = c(-0.6,0.6),breaks = c(-0.6,-0.4,-0.2,0,0.2,0.4,0.6,0.8)) +
